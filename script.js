...
// Functionality For Project Card Hover
let projectCard = document.querySelectorAll(".project-card");
let cardLayer = document.querySelectorAll(".project-card .card-layer");
let cardCount = document.querySelectorAll(".project-row .card-count");

projectCard.forEach((card, index) => {
  card.addEventListener("mouseenter", () => {
    cardLayer[index].style.bottom = "0";
    cardCount[index].style.backgroundColor = "#b4b4b4";
    card.style.transition = "all 0.4s ease";
  });
  card.addEventListener("mouseleave", () => {
    cardLayer[index].style.bottom = "-100%";
    cardCount[index].style.backgroundColor = "#ffac58";
